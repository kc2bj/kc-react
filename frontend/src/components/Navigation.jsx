    ...
    <nav className="w-full py-6 px-4 dark:bg-espresso-bg dark:text-espresso-text transition-colors duration-300">
      ...
      >
        ...
        <button
          ...
          className="ml-4 p-2 rounded-full border border-neutral-300 hover:bg-neutral-200 dark:hover:bg-neutral-700 transition"
          aria-label="Toggle Theme"
        >
          <span title="Toggle Dark Mode" className="transition-transform duration-300 ease-in-out transform hover:rotate-90">

    ...
    <nav className="w-full py-6 px-4 bg-white dark:bg-espresso-bg dark:text-espresso-text transition-colors duration-300 shadow-lg sticky top-0 z-50">
      ...
      >
        ...
        <ul className="hidden sm:flex gap-4 text-neutral-800 text-sm">
          ...
          <li><a href="https://theiamgroup.org/#work" target="_blank" rel="noopener noreferrer" className="px-3 py-1 rounded-full transition relative overflow-hidden no-underline hover:no-underline hover:bg-espresso-leaf hover:text-white dark:hover:bg-espresso-leaf dark:hover:text-white">Work</a></li>
          <li><NavLink to="/case-studies" className={linkClasses}>Case Studies</NavLink></li>
